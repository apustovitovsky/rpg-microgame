...
7. В начале каждого сообщения кратко указывай цель шага и приблизительно процент завершенности общей задачи, а в конце шага указывай что именно было получено на текущем шаге.
