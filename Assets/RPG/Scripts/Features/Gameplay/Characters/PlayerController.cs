...
{
    public sealed class PlayerController : IPlayerInputHandler, ITickable
    {
        private readonly CharacterController _controller;
        private readonly ITimeProvider _gameTime;
        private readonly ICharacterGravityService _gravityService;
        ...
        public PlayerController(
            ...
            ICharacterGravityService gravityService)
        {
