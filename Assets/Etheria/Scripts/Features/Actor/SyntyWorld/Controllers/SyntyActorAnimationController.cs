...
namespace Etheria.Features.Actor
{
    public class SyntyActorAnimationController : MonoBehaviour
    {
        ...
        private IGameInputRouter _inputReader;

        [Inject]
        public void Construct(
            IGameInputRouter playerInput)
        {
        ...
        private void EnableLockOn(bool enable)
        {
            ...
            {
                _currentLockOnTarget.GetComponent<SyntyObjectLockOn>().Highlight(true, true);
            }
        }
        ...
        private void UpdateBestTarget()
        {
            ...
            else
            {
                ...
                {
                    target.GetComponent<SyntyObjectLockOn>().Highlight(false, false);
            ...
            if (!_isLockedOn)
            {
                ...
                if (_currentLockOnTarget != null)
                {
                    _currentLockOnTarget.GetComponent<SyntyObjectLockOn>().Highlight(true, false);
                }
            }
            else
            {
