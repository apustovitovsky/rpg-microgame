...
namespace Etheria.Features.Actor
{
        ...
        ICameraPivotProvider
    {
        ...
        [field: SerializeField, ReadOnlyField] public Transform AimPoint { get; private set; }
        [field: SerializeField, ReadOnlyField] public Transform CameraRoot { get; private set; }
        [field: SerializeField, ReadOnlyField] public Transform CameraPivot { get; private set; }
        [field: SerializeField, ReadOnlyField] public Transform UiAnchor { get; private set; }
        [field: SerializeField, ReadOnlyField] public ActorHitbox[] Hitboxes { get; private set; }
